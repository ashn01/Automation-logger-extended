...
namespace Automation_logger_extended.Controllers
{
    ...
    public class TestScriptController : ControllerBase
    {
        ...
        public IActionResult Init()
        {
            try
            {
                string[] array = new string[] {"Automated Acceptance Test/Audit - Client Acceptance Part 1.t",
...
"Audit and Financials Combined files/TD-1744 Audit and Financials Combined File - Functionality.t" };
                ...
                {
                    _testScriptRepository.Create(new Models.TestScript { Name = test, Order = order += 10 });
